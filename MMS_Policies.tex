...
\begin{itemize}
    ...
    \item In general, no epoxy work (including with pre-thickened epoxy) may be done over the carpeted area unless an exemption is given by the Executive and Leadership Boards and proper protective measures are taken.
    ...
    \item After working with epoxy, all working surface(s) must be throughly cleaned. Epoxy (including pre-thickened epoxy) may not be used or remain on whiteboard tables or work tables in any form, unless an exemtion is given by the Executive and Leadership boards and protection measures are taken.
